// Names follow the current postal administrative-area dataset. Region and district are
// stored together in vote snapshots so repeated names such as 東區 remain unambiguous.
...
export function isValidDistrict(region: string | null | undefined, district: string | null | undefined) {
  if (!district) return true;
  return Boolean(region && TAIWAN_DISTRICTS[region]?.includes(district));
}
