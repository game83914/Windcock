<template>
  <div class="flex items-center gap-2">
    <img v-if="modelValue" :src="modelValue" alt="選項圖片" class="h-12 w-12 shrink-0 rounded-lg border border-[#ded7cb] bg-[#f0e6d2] object-cover" />
    ...
    <label class="cursor-pointer">
      <span class="sr-only">上傳選項圖片</span>
      <input type="file" accept="image/png,image/jpeg,image/webp" class="sr-only" :disabled="uploading" @change="onFile" />
    </label>
